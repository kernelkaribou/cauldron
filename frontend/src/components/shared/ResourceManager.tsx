...
export function ResourceManager({ techniqueId }: ResourceManagerProps) {
  ...
  return (
    <div className="p-4 bg-card border border-border rounded-xl">
      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="mb-3 p-3 bg-page rounded-lg space-y-2">
          ...
          <button type="submit" disabled={addResource.isPending} className="px-3 py-1.5 bg-accent text-white rounded text-xs hover:bg-accent-light disabled:opacity-50">Add Resource</button>
        </form>
      )}
